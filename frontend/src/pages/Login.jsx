...
const Login = () => {
  ...
  return (
    ...
    >
      <div className=" inline-flex items-center gap-2 mb-2 mt-10">
        <p className=" text-4xl text-black">{currentState}</p>
        <hr className=" border-none h-[3px] w-8 bg-black" />
      </div>
      {currentState == "Login" ? (
        ""
      ) : (
      ...
      <button className=" bg-neonGreen text-black font-semibold border-2 rounded-xl border-black px-8 py-2 mt-4">
        {currentState === "Login" ? "Sign In" : "Sign Up"}
      </button>
    </form>
  );
